    ...
    public void mandarCorreo() {
        ...
        try {
            ...
            InternetAddress[] internetAddresses = {
                new InternetAddress("lmrosales0@misena.edu.co"),
                new InternetAddress("liliana.princess16@hotmail.com"),
                new InternetAddress("chris930211@hotmail.com")};
            ...
            mimeMessage.setSubject("OrfiPlus.com");

            // Creo la parte del mensaje
            MimeBodyPart mimeBodyPart = new MimeBodyPart();
            mimeBodyPart.setText("El mensaje que se desea");
